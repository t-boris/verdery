...
| `POST .../media` (registration)     | 60/hour                       | A heavy capture session is tens of photos. 60/hour bounds `T-COST-03`'s storage-exhaustion vector at 60 × 50 MiB = 3 GiB/hour per profile even before the storage ceiling below.                                                                                                                          |
