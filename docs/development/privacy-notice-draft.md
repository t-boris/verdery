...
| Data                                                                                                                               | Purpose                                  | Basis framing                | Where it lives                                                                                               | Retention                              | Evidence                                                                                                                   |
| ---------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | ---------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| WGS84 anchor and optional confirmed display address of the property (`geographic_anchor geometry(Point, 4326)`, `display_address`) | Placing and recognizing the map location | Necessary to provide service | `gardens_mapping.georeference` — history-preserving, authored through `PUT /gardens/{gardenId}/georeference` | With the garden (ENFORCED, if present) | `migrations/1784800000000_…sql`; `migrations/1788700000000_georeference-display-address.sql`; `set-garden-georeference.ts` |
