...
export const russianCandidatesMessages = {
  ...
  'candidates.photoAnalysisTitle': 'Анализ фотографии',
  'candidates.photoAnalysisNotice':
    'Визуальные оценки созданы ИИ. Проверьте их, прежде чем считать подтверждёнными данными сада.',
  'candidates.photoAnalysisAnalyzedAt': 'Проанализировано: {date}',
  'candidates.photoAnalysisScientificName': 'Научное название',
  'candidates.photoAnalysisCommonName': 'Обиходное название',
  'candidates.photoAnalysisFamily': 'Семейство',
  'candidates.photoAnalysisGenus': 'Род',
  'candidates.photoAnalysisVariety': 'Сорт',
  'candidates.photoAnalysisConfidence': 'Уверенность распознавания',
  'candidates.photoAnalysisLifecycle': 'Видимая стадия роста',
  'candidates.photoAnalysisAge': 'Примерный видимый возраст',
  'candidates.photoAnalysisAgeValue': '{min}–{max} мес.',
  'candidates.photoAnalysisAcquisition': 'Предполагаемая дата приобретения',
  'candidates.photoAnalysisConditionTitle': 'Предположение о состоянии',
  'candidates.photoAnalysisConditionConfidence': 'Уверенность предположения: {confidence}',
  'candidates.photoAnalysisEvidence': 'Видимые признаки: {evidence}',
  'candidates.photoAnalysisAlternatives': 'Другие возможные объяснения',
  'candidates.photoAnalysisCareGuidance': 'Общая рекомендация по уходу: {guidance}',
  'candidates.photoAnalysisMoreEvidence': 'Для проверки анализа нужны дополнительные фотографии.',
  'candidates.photoAnalysisRequestedViews': 'Нужные ракурсы: {views}',
  'candidates.photoAnalysisSafetyInformational': 'Информационно',
  'candidates.photoAnalysisSafetyMonitor': 'Стоит понаблюдать',
  'candidates.photoAnalysisSafetyExpert': 'Рекомендуется консультация специалиста',
  ...
  'candidates.taxonomyLinked': 'Таксономическая ссылка установлена',
