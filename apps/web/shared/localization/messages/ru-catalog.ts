...
export const russianCatalogMessages = {
  ...
  'catalog.profileNoFactsTitle': 'Проверенные садоводческие сведения ещё собираются',
  'catalog.profileNoFacts':
    'Ботаническая идентификация уже доступна выше. Сведения об уходе, выращивании, сезонности, безопасности и использовании в саду появятся здесь только после проверки источников.',
