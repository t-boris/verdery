...
export const russianMessages: MessageCatalogue = {
  ...
  'gardens.createNamePlaceholder': 'Назовите свой сад…',
  'gardens.createSubmit': 'Создать сад',
  'gardens.nameSuggestions': 'Варианты',
  'gardens.nameSuggestionHome': 'Домашний сад',
  'gardens.nameSuggestionBackyard': 'Задний двор',
  'gardens.nameSuggestionCommunity': 'Общий участок',
  ...
  'gardens.detailsTitle': 'Сведения о саде',
  'gardens.detailsDescription': 'Проверьте основные сведения и историю записи этого сада.',
  'gardens.createdAt': 'Создан',
  'gardens.updatedAt': 'Последнее изменение',
