...
export const englishMessages = {
  ...
  'gardens.detailsTitle': 'Garden details',
  'gardens.detailsDescription': 'Review this garden’s identity and record history.',
  'gardens.createdAt': 'Created',
  'gardens.updatedAt': 'Last updated',
