...
export const englishMapMessages = {
  ...
  'map.objectList.show': 'Show',
  'map.objectList.hide': 'Hide',
  'map.objectList.lock': 'Lock',
  'map.objectList.unlock': 'Unlock',
  'map.objectList.actionsFor': 'Actions for {label}',
  'map.objectList.deleteAriaLabel': 'Delete {label}',
  'map.objectList.selectAriaLabel': 'Select {label}, {category}',
  'map.objectList.selectAriaLabelLocked': '{label}, {category}, locked',
  'map.objectList.layerLockedTooltip': 'This object’s layer is locked',
  'map.objectList.objectLockedTooltip': 'This object is locked',
  'map.objectList.hideAriaLabel': 'Hide {label} on the map',
  'map.objectList.showAriaLabel': 'Show {label} on the map',
  'map.objectList.lockAriaLabel': 'Lock {label}',
  'map.objectList.unlockAriaLabel': 'Unlock {label}',
  'map.objectList.displayStateSaved': 'Object visibility and lock state saved.',
  ...
  'map.status.objectLocked': 'This object is locked. Unlock it in the Objects panel to edit it.',
  ...
  'map.inspector.width': 'Panel width',
  'map.inspector.narrow': 'Narrow the panel',
  'map.inspector.widen': 'Widen the panel',
  'map.inspector.resetWidth': 'Reset panel width',
