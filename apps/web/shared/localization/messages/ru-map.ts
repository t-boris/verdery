...
export const russianMapMessages: Readonly<Record<keyof typeof englishMapMessages, string>> = {
  ...
  'map.objectList.show': 'Показать',
  'map.objectList.hide': 'Скрыть',
  'map.objectList.lock': 'Заблокировать',
  'map.objectList.unlock': 'Разблокировать',
  'map.objectList.actionsFor': 'Действия с объектом «{label}»',
  'map.objectList.deleteAriaLabel': 'Удалить {label}',
  'map.objectList.selectAriaLabel': 'Выбрать {label}, {category}',
  'map.objectList.selectAriaLabelLocked': '{label}, {category}, заблокирован',
  'map.objectList.layerLockedTooltip': 'Слой этого объекта заблокирован',
  'map.objectList.objectLockedTooltip': 'Этот объект заблокирован',
  'map.objectList.hideAriaLabel': 'Скрыть {label} на карте',
  'map.objectList.showAriaLabel': 'Показать {label} на карте',
  'map.objectList.lockAriaLabel': 'Заблокировать {label}',
  'map.objectList.unlockAriaLabel': 'Разблокировать {label}',
  'map.objectList.displayStateSaved': 'Видимость и блокировка объекта сохранены.',
  ...
  'map.status.objectLocked':
    'Этот объект заблокирован. Разблокируйте его на панели «Объекты», чтобы редактировать.',
  ...
  'map.inspector.width': 'Ширина панели',
  'map.inspector.narrow': 'Сделать панель уже',
  'map.inspector.widen': 'Сделать панель шире',
  'map.inspector.resetWidth': 'Вернуть обычную ширину панели',
