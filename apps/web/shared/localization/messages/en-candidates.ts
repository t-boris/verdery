...
export const englishCandidatesMessages = {
  ...
  'candidates.photoAnalysisTitle': 'Photo analysis',
  'candidates.photoAnalysisNotice':
    'AI-generated visual estimates. Review them before using them as accepted garden facts.',
  'candidates.photoAnalysisAnalyzedAt': 'Analyzed {date}',
  'candidates.photoAnalysisScientificName': 'Scientific name',
  'candidates.photoAnalysisCommonName': 'Common name',
  'candidates.photoAnalysisFamily': 'Family',
  'candidates.photoAnalysisGenus': 'Genus',
  'candidates.photoAnalysisVariety': 'Variety',
  'candidates.photoAnalysisConfidence': 'Identification confidence',
  'candidates.photoAnalysisLifecycle': 'Visible growth stage',
  'candidates.photoAnalysisAge': 'Estimated visible age',
  'candidates.photoAnalysisAgeValue': '{min}–{max} months',
  'candidates.photoAnalysisAcquisition': 'Estimated acquisition date',
  'candidates.photoAnalysisConditionTitle': 'Condition suggestion',
  'candidates.photoAnalysisConditionConfidence': 'Suggestion confidence: {confidence}',
  'candidates.photoAnalysisEvidence': 'Visible evidence: {evidence}',
  'candidates.photoAnalysisAlternatives': 'Other possible explanations',
  'candidates.photoAnalysisCareGuidance': 'General care guidance: {guidance}',
  'candidates.photoAnalysisMoreEvidence':
    'The analysis requests more photographic evidence before review.',
  'candidates.photoAnalysisRequestedViews': 'Requested views: {views}',
  'candidates.photoAnalysisSafetyInformational': 'Informational',
  'candidates.photoAnalysisSafetyMonitor': 'Worth monitoring',
  'candidates.photoAnalysisSafetyExpert': 'Expert review recommended',
  ...
  'candidates.taxonomyLinked': 'Taxonomy reference linked',
