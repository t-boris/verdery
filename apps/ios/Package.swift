...
//
// `Verdery.xcodeproj` is a thin deployment shell generated from project.yml;
// this file remains the source of truth for every module boundary. See
// README.md, section "Xcode project", which documents that arrangement fully.
//
...
let package = Package(
    ...
    targets: [
        ...
        // Wiring is not worth testing; the pure status mapping beside it is.
        .testTarget(name: "AppCompositionTests", dependencies: ["AppComposition", "CoreSynchronization"]),
    ]
)
