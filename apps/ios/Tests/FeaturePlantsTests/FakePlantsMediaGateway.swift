...
/// In-memory `MediaGateway` stand-in for `FeaturePlantsTests` — just enough
/// for the photo-gallery flow: scriptable signed-access URLs keyed by
/// `mediaId`. Distinct from `FeatureMapTests`' own `FakeMapMediaGateway`,
/// which models the plan-background flows this feature never drives.
final class FakePlantsMediaGateway: MediaGateway, @unchecked Sendable {
