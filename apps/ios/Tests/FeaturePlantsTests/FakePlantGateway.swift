...
final class FakePlantGateway: PlantGateway, @unchecked Sendable {
    ...
    var searchPlantsQueries: [(query: String?, status: [PlantStatus]?, cursor: String?)] = []
    ...
    func searchPlants(
        gardenId: String, query: String?, status: [PlantStatus]?, cursor: String?, limit: Int?
    ) async throws -> PlantSearchPage {
        if let searchPlantsError { throw searchPlantsError }
        searchPlantsQueries.append((query: query, status: status, cursor: cursor))
