...
describe.skipIf(!dockerAvailable)(SUITE_NAME, () => {
  ...
  it('rolls back cleanly, leaving no trace of any of the ten new tables', async () => {
    ...
    // it (1786800000000_engagement-publisher-grant-and-client-update-items
    // .sql, nothing this file's own assertions below check) first, then
    // this migration itself. Update this count when a later migration is
    // added on top — the same convention every earlier migration test in
