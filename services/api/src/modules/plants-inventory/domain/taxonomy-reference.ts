 ...
 * reference (`source: 'system_catalog'`), one a profile defined themselves
 * (`source: 'user_defined'`), or an unreviewed reference created from a
 * confident photo-identification result (`source: 'provider_sourced'`).
 *
...
export type TaxonomySource = 'system_catalog' | 'user_defined' | 'provider_sourced';
