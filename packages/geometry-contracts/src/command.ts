...
import type { ObjectSourceMetadata } from './image-extraction-source.js';
...
export interface CreateObjectSource {
  ...
  /** Full durable lineage when a source has more identity than an enum can express. */
  readonly metadata?: ObjectSourceMetadata;
}
